                    ...
                    <div class="card card-primary">
                        <form method="post" action="{{route('mahasiswa.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>NPM</label>
                                    <input type="number" name="npm" class="form-control" required="" placeholder="Masukkan NPM">
                                </div>
                                <div class="form-group">
                                    <label>Jurusan</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_kategori_univ" id="id_kategori_univ" class="form-control">
                                        <option >--Pilih--</option>
                                        @foreach ($kategoriuniv as $item)
                                            <option value="{{ $item->id_kategori_univ}}">{{ $item->nama_universitas}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Tahun Masuk</label>
                                    <select name="id_tahun_masuk" id="id_tahun_masuk" class="form-control">
                                        <option >--Pilih--</option>
                                        @foreach ($tahunmasuk as $item)
                                            <option value="{{ $item->id_tahun_masuk}}">{{ $item->tahun_masuk}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>No Telp</label>
                                    <input type="number" name="no_telepon" class="form-control" required="" placeholder="Masukkan No Telp">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
